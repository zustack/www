        ...
        <div className="mx-auto max-w-screen-xl">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <a href="https://zustack.com" className="flex items-center">
                <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">
                  Zustack
                </span>
              </a>
              <p className="flex gap-1 text-sm mt-4 text-zinc-400">
                <span>Zustack is currently in mantained by</span>
                <a
            ...
            <div className="grid grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-2">
              <div>
                ...
                <ul className="text-zinc-400">
                  ...
                  <li className="mb-4">
                    <a href="#how-we-work" className="hover:underline">
                      How we work
                    </a>
                  </li>
                </ul>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm sm:text-center text-zinc-500">
              © 2024{" "}
              <a href="https://zustack.com" className="hover:underline">
                Zustack
              </a>
              . All Rights Reserved.
            </span>
